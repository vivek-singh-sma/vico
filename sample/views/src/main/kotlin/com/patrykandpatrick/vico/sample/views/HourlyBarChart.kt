...
import com.patrykandpatrick.vico.sample.views.databinding.HourlyBarChartBinding
...
@Composable
fun ViewHourlyBarChart(modifier: Modifier) {
  ...
  AndroidViewBinding(
    { inflater, parent, attachToParent ->
      HourlyBarChartBinding.inflate(inflater, parent, attachToParent).apply {
        with(chartView) {
