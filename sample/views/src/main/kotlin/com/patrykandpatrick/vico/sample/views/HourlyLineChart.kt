...
import com.patrykandpatrick.vico.sample.views.databinding.HourlyLineChartBinding
...
@Composable
fun ViewHourlyLineChart(modifier: Modifier) {
  ...
  AndroidViewBinding(
    { inflater, parent, attachToParent ->
      HourlyLineChartBinding.inflate(inflater, parent, attachToParent).apply {
        with(chartView) {
            ...
            if (axis is HorizontalAxis<*>) {
              (chart as? com.patrykandpatrick.vico.core.cartesian.CartesianChart)?.let { chart ->
                val updatedAxis = axis.copy(
                  ...
                  itemPlacer = DynamicHourlyItemPlacer()
                )
