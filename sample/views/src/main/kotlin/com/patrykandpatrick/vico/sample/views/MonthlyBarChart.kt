...
import com.patrykandpatrick.vico.sample.views.databinding.MonthlyBarChartBinding
...
@Composable
fun ViewMonthlyBarChart(modifier: Modifier) {
  ...
  AndroidViewBinding(
    { inflater, parent, attachToParent ->
      MonthlyBarChartBinding.inflate(inflater, parent, attachToParent).apply {
        with(chartView) {
