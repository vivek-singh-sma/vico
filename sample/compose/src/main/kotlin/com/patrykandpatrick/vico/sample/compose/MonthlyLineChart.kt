...
@Composable
private fun JetpackComposeMonthlyLineChart(
...
@Composable
fun JetpackComposeMonthlyLineChart(modifier: Modifier = Modifier) {
  ...
  JetpackComposeMonthlyLineChart(modelProducer, modifier)
}
...
private fun Preview() {
  ...
  PreviewBox { JetpackComposeMonthlyLineChart(modelProducer) }
}
