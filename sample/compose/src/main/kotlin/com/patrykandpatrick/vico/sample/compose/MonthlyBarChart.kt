...
@Composable
private fun JetpackComposeMonthlyBarChart(
...
@Composable
fun JetpackComposeMonthlyBarChart(modifier: Modifier = Modifier) {
  ...
  JetpackComposeMonthlyBarChart(modelProducer, modifier)
}
...
private fun Preview() {
  ...
  PreviewBox { JetpackComposeMonthlyBarChart(modelProducer) }
}
