...
@Composable
private fun JetpackComposeHourlyLineChart(
...
@Composable
fun JetpackComposeHourlyLineChart(modifier: Modifier = Modifier) {
  ...
  JetpackComposeHourlyLineChart(modelProducer, modifier)
}
...
private fun Preview() {
  ...
  PreviewBox { JetpackComposeHourlyLineChart(modelProducer) }
}
